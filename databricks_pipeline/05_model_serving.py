...
# Set DATABRICKS_TOKEN as environment variable before running.
databricks_token = os.getenv("DATABRICKS_TOKEN")
if not databricks_token:
    raise ValueError("DATABRICKS_TOKEN is not set. Set it as an environment variable before running.")
...
anomaly_score = float(probs[1])  # class 1이 anomaly라고 가정
